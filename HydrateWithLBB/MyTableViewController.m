...
- (void)viewDidLoad
{
    ...
    NSFetchRequest *fetchRequest = [[NSFetchRequest alloc] initWithEntityName:@"DailyDrinkSummary"];
...
{
    UITableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:@"drinkPerDayCell" forIndexPath:indexPath];
